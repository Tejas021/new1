...
<body>
  ...
  <%= hitsCount%>
    ...
    <h3 style="margin-left: 20px;">Your Student Records:</h3>
    <br>
...
<div class="TableCont">
    <h4 style="margin-left: 20px;">Sorted Students</h4>
    <div class="table-responsive">
        <table class="table table-bordered table-dark">
            <thead>
                <tr>
                    
                    <th scope="col" colspan="1" style="text-align: center;">Slower Leaners</th>
                    <th scope="col" colspan="1" style="text-align: center;">Average Leaners</th>
                    <th scope="col" colspan="1" style="text-align: center;">Faster Leaners</th>
               </tr>
            </thead>
